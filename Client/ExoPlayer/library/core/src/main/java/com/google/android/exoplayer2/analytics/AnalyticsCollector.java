...
public class AnalyticsCollector
  ...
  private static String TAG = "AnalyticsCollector";
  ...
  protected AnalyticsCollector(@Nullable Player player, Clock clock) {
    ...
    try {
      ...
      logStream.write("open: " + SystemClock.elapsedRealtime());
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onVideoEnabled(DecoderCounters counters) {
    // The renderers are only enabled after we changed the playing media period.
    EventTime eventTime = generatePlayingMediaPeriodEventTime();
    // Log.e(TAG, "onVideoEnabled: " + eventTime.realtimeMs);
    try {
      logStream.write("onVideoEnabled: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onVideoInputFormatChanged(Format format) {
    EventTime eventTime = generateReadingMediaPeriodEventTime();
    // Log.e(TAG, "onVideoInputFormatChanged: " + eventTime.realtimeMs + "; width: " + format.width);
    try {
      logStream.write("onVideoInputFormatChanged: " + eventTime.realtimeMs + "," + format.width);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onDroppedFrames(int count, long elapsedMs) {
    EventTime eventTime = generateLastReportedPlayingMediaPeriodEventTime();
    // Log.e(TAG, "onDroppedFrames: " + eventTime.realtimeMs + "; count: " + count);
    try {
      logStream.write("onDroppedFrames: " + eventTime.realtimeMs + ", " + count);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onVideoDisabled(DecoderCounters counters) {
    ...
    // but before this change is reported to the app thread.
    EventTime eventTime = generateLastReportedPlayingMediaPeriodEventTime();
    // Log.e(TAG, "onVideoDisabled: " + eventTime.realtimeMs);
    try {
      logStream.write("onVideoDisabled: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onRenderedFirstFrame(@Nullable Surface surface) {
    EventTime eventTime = generateReadingMediaPeriodEventTime();
    // Log.e(TAG, "onRenderedFirstFrame: " + eventTime.realtimeMs);
    try {
      logStream.write("onRenderedFirstFrame: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onMediaPeriodCreated(int windowIndex, MediaPeriodId mediaPeriodId) {
    ...
    // Log.e(TAG, "onMediaPeriodCreated: " + eventTime.realtimeMs);
    try {
      logStream.write("onMediaPeriodCreated: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onMediaPeriodReleased(int windowIndex, MediaPeriodId mediaPeriodId) {
    EventTime eventTime = generateMediaPeriodEventTime(windowIndex, mediaPeriodId);
    // Log.e(TAG, "onMediaPeriodReleased: " + eventTime.realtimeMs);
    try {
      logStream.write("onMediaPeriodReleased: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.close();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onLoadStarted(
    ...
    EventTime eventTime = generateMediaPeriodEventTime(windowIndex, mediaPeriodId);
    // Log.e(TAG, "onLoadStarted: " + eventTime.realtimeMs);
    try {
      logStream.write("onLoadStarted: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onLoadCompleted(
      ...
      MediaLoadData mediaLoadData) {
    EventTime eventTime = generateMediaPeriodEventTime(windowIndex, mediaPeriodId);
    // Log.e(TAG, "onLoadCompleted: " + eventTime.realtimeMs);
    try {
      logStream.write("onLoadCompleted: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public final void onReadingStarted(int windowIndex, MediaPeriodId mediaPeriodId) {
    ...
    EventTime eventTime = generateMediaPeriodEventTime(windowIndex, mediaPeriodId);
    // Log.e(TAG, "onReadingStarted: " + eventTime.realtimeMs);
    try {
      logStream.write("onReadingStarted: " + eventTime.realtimeMs);
      logStream.newLine();
      logStream.flush();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  private static final class MediaPeriodQueueTracker {
    ...
    public void onReadingStarted(MediaPeriodId mediaPeriodId) {
      Log.e("TAG", "onReadingStarted: " + mediaPeriodId.periodUid);
