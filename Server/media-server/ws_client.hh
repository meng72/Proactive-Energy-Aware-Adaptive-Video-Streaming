...
public:
  ...
  double video_playtrack_timeline() const { return video_playtrack_timeline_; }
  ...
  std::optional<uint64_t> select_video_ts() const { return select_video_ts_; }
  std::optional<uint64_t> last_video_send_ts() const { return last_video_send_ts_; }
  std::optional<uint64_t> prev_video_ack_ts() const { return prev_video_ack_ts_; }
  std::optional<uint64_t> curr_video_ack_ts() const { return curr_video_ack_ts_; }
  ...
  void set_video_playtrack_timeline(const double buf) { video_playtrack_timeline_ = buf; }
  ...
  void set_select_video_ts(const std::optional<uint64_t> send_ts) { select_video_ts_ = send_ts; }
  void set_last_video_send_ts(const std::optional<uint64_t> send_ts) { last_video_send_ts_ = send_ts; }
  void set_prev_video_ack_ts(const std::optional<uint64_t> ack_ts) { prev_video_ack_ts_ = ack_ts; }
  void set_curr_video_ack_ts(const std::optional<uint64_t> ack_ts) { curr_video_ack_ts_ = ack_ts; }
  ...
  static constexpr double MAX_BUFFER_S = 7.0;  /* seconds */
...
private:
  ...
  double video_playtrack_timeline_ {0};
  ...
  /* sending time of last video chunk (unit: ms) */
  std::optional<uint64_t> select_video_ts_ {};
  std::optional<uint64_t> last_video_send_ts_ {};
  std::optional<uint64_t> prev_video_ack_ts_ {}; 
  std::optional<uint64_t> curr_video_ack_ts_ {};
