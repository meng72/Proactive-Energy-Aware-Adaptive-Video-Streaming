                           ...
                           WebSocketClient & client)
{
  ...
  client.set_select_video_ts(timestamp_ms());
                        ...
                        const ClientInitMsg & msg)
{
  ...
  // after receiving init from the client, record it as ack_ts
  client.set_curr_video_ack_ts(timestamp_ms());
...
void handle_client_info(WebSocketClient & client, const ClientInfoMsg & msg)
{
  ...
  client.set_video_playtrack_timeline(msg.video_timeline);
                             ...
                             const ClientVidAckMsg & msg)
{
  ...
  if (client.last_video_send_ts()) {
    ...
    client.set_prev_video_ack_ts(client.curr_video_ack_ts().value());
    client.set_curr_video_ack_ts(timestamp_ms());
